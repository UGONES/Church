  ...
  const verifyEmailToken = async (jwtToken) => {
    try {
      ...
      if (error.response?.status === 400) {
        ...
        setStatus("error");
        alert.error(
          "Verification link not found. Please request a new verification email.",
        );
      } else {
        setStatus("error");
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="text-center">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-[#FF7E45] text-white py-2 px-4 rounded-md"
                  >
                    Continue Now
                  </button>
                  <button
            ...
            {status === "expired" && (
              <div className="text-center">
                <p className="mb-6">
                  ...
                  valid for 24 hours. We will resend a new verification email
                  to:
                </p>
            ...
            {status === "error" && (
              <div className="text-center">
                <p className="mb-6">
                  There was a problem verifying your email address. This may be
                  due to an invalid or malformed verification link.
                </p>
                <div className="space-y-3">
                  <button
                    onClick={handleGoToLogin}
            ...
            {status === "waiting" && (
              <div className="text-center">
                <p className="mb-6">
                  We are waiting for you to verify your email. Please check your
                  inbox.
                </p>
                <div className="space-y-3">
                  <button
                    onClick={handleGoToLogin}
                    className="w-full bg-[#FF7E45] text-white px-4 py-2 rounded-md"
                  >
                    Go to Login
                  </button>
                </div>
