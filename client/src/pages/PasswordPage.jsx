...
const PasswordPage = () => {
  ...
  useEffect(() => {
    document.title =
      "SMC: - Forgotten-Password | St. Micheal`s & All Angels Church | Ifite-Awka";
        ...
        <div className="max-w-md mx-auto">
            ...
            <div className="w-20 h-20 mx-auto mb-4 flex items-center justify-center">
              {mode === "success" ? (
                ...
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
                  <i className="fas fa-lock text-blue-500 text-3xl" />
                </div>
              )}
            </div>
          ...
          {(mode === "reset" || mode === "change") && (
            <div className="bg-white rounded-lg shadow-md p-6">
              <form
                onSubmit={
                  mode === "reset" ? handleResetPassword : handleChangePassword
                }
                className="space-y-4"
              >
          ...
          {mode === "success" && (
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <div className="mb-4">
                <i className="fas fa-envelope text-4xl text-[#FF7E45] mb-3" />
