...
app.get('/', (req, res) => res.json({ message: 'Church API Server is running!', status: 'OK', timestamp: new Date().toISOString() }) );

// Health check endpoint
app.get('/health', (req, res) => res.status(200).json({ status: '✅ OK', message: '🚀 Server is running', timestamp: new Date().toISOString() }) );
